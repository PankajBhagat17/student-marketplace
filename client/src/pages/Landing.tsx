...
export default function Landing() {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', overflowX: 'hidden', boxSizing: 'border-box' }}>
      ...
      {/* Perfectly Responsive Mobile Navigation */}
      <nav style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 5vw', width: '100%', boxSizing: 'border-box', gap: '15px' }}>
        
        {/* Top Row: Logo & Sign In Button side-by-side on mobile */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', maxWidth: '1200px' }}>
          <div style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)', letterSpacing: '-0.025em', color: 'hsl(var(--foreground))', fontFamily: "var(--font-display)", fontWeight: 'normal' }}>
            CampusTrade
          </div>
          ...
          <button 
            ...
            style={{ borderRadius: '9999px', padding: '0.5rem 1.25rem', fontSize: '0.85rem', color: 'hsl(var(--foreground))', cursor: 'pointer', whiteSpace: 'nowrap' }}
          >
            Sign In ›
          </button>
        </div>

        {/* Bottom Row: Navigation Links centered neatly below */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', fontSize: '0.9rem', color: 'hsl(var(--muted-foreground))', width: '100%' }}>
      ...
      {/* Hero Content */}
      <main style={{ position: 'relative', zIndex: 10, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '20px 5vw', boxSizing: 'border-box' }}>
        <h1 
          className="animate-fade-rise"
          style={{ fontSize: 'clamp(2.2rem, 7vw, 5.5rem)', lineHeight: 1.1, letterSpacing: '-1.5px', maxWidth: '1100px', fontWeight: 400, color: 'hsl(var(--foreground))', fontFamily: "var(--font-display)", margin: 0 }}
        >
        ...
        <p className="animate-fade-rise-delay" style={{ color: 'hsl(var(--muted-foreground))', fontSize: 'clamp(0.9rem, 1.5vw, 1.2rem)', maxWidth: '40rem', marginTop: '1.5rem', lineHeight: 1.5 }}>
        ...
        <button 
          ...
          style={{ borderRadius: '9999px', padding: '0.9rem 2.5rem', fontSize: '0.95rem', color: 'hsl(var(--foreground))', marginTop: '2rem', cursor: 'pointer' }}
        >
          Start Browsing
        </button>
      </main>
